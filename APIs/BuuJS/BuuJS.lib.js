...
const BuuJS = new function() {
	var that = this;
	this.version = "0.1a";
	this.get = new function(element_name) {
		//return new element type
		var g_that = this;
		this.element = document.querySelectorAll(element_name);
		this.animate = function(properties, type, duration) {
			...
			return new Animation(g_that.element, properties, type, duration);
		};
	};
};
