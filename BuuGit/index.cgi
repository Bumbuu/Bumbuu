...
our $GIT = "/home2/bumbuuco/git/bin/git";
...
sub print_search_form {
	...
	print $cgi->startform(-method => "get", -action => $action) .
	      ...
	      $cgi->popup_menu(-name => 'st', -default => 'commit',
	                       -class => "bumbuu_selectarea_light",
	                       -values => ['commit', 'grep', 'author', 'committer', 'pickaxe']) .
	      $cgi->sup($cgi->a({-href => href(action=>"search_help")}, "?")) .
	      " \n",
	      # " search:\n",
	      $cgi->textfield(-name => "s", -value => $searchtext, -override => 1,
	      -id => "search_within_repo",
	      -class => "bumbuu_input_light", -placeholder => "Search") . "\n" .
...
EOF
	...
	print "<div id=\"main_title\">BuuGit</div>\n";
	print "<div id=\"main\">\n"; # the main div
...
sub git_project_search_form {
	...
	print $cgi->textfield(-name => 's', -value => $searchtext,
	                      -size => 60, -class => "bumbuu_input_light",
	                      -placeholder => "Search for a project by name and description$limit") . "\n" .
	      $cgi->submit(-name => 'btnS', -value => 'Search', -class => "bumbuu_button_light") .
	      "<span title=\"Extended regular expression\">" .
	      $cgi->checkbox(-name => 'sr', -value => 1, -label => 're',
	                     -checked => $search_use_regexp) .
	      "</span>\n" .
